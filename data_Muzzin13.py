...
def function_data(z_0to6, logMstar_0to4):
    ...
    '''
        The units are:  log(eta [Mpc^-3])    log(rho [solar mass Mpc^-3])
        a, q, and f meaning: all, quiescent, and star-forming galaxies are taken into account
    '''
    output = [10**(log_eta_a[z_0to6][logMstar_0to4]), 10**(log_eta_q[z_0to6][logMstar_0to4]), 10**(log_eta_f[z_0to6][logMstar_0to4]),
              10**(log_rho_a[z_0to6][logMstar_0to4]), 10**(log_rho_q[z_0to6][logMstar_0to4]), 10**(log_rho_f[z_0to6][logMstar_0to4])]
    return output
